...
language: en
modified: '2019-06-03T01:01:34.91241Z'
...
## Challenge
Considering the image below, a box rotates about the x-axis at a constant rate of `$\gamma = 5 \pi$` rad/s. For the case where there is no rotation about the Z-axis (N=0), calculate the **acceleration** of point B on the disk as the angle `$\gamma = 60 \degree$` is passed. The disk rotates at a speed of 180 rev/min.
