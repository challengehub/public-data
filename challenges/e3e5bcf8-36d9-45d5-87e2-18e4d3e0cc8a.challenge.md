...
language: en
modified: '2019-04-17T04:51:15.290331Z'
...
4. If `$z_1$` is a root of a polynomial equation with *nonreal* coefficients, then its conjugate `$z_2 =\overline z_1$` is not necessarily a root. Prove this result in the case of a quadratic equation `$az^2 + bz + c = 0 $`, where at least one fo the coefficients `$a=\not 0$`, `$b$` or `$c$` is not real.
